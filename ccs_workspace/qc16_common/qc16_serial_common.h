...
#define SERIAL_OPCODE_APPFILE   0x10
#define SERIAL_OPCODE_ENDFILE   0x11
#define SERIAL_OPCODE_SETID     0x12
#define SERIAL_OPCODE_SETNAME   0x13
#define SERIAL_OPCODE_STATQ     0x14
#define SERIAL_OPCODE_STATA     0x15
